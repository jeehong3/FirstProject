		...
		<main>
			...
			<section id="hero">
				<div id="owl-main" class="owl-carousel height-md owl-inner-nav owl-ui-lg">
					...
					<div class="item" style="background-image: url(/farmstory/resources/assets/images/art/slider01.jpg);">
						<div class="container">
					...
					<div class="item" style="background-image: url(/farmstory/resources/assets/images/art/slider02.jpg);">
						<div class="container">
					...
					<div class="item" style="background-image: url(/farmstory/resources/assets/images/art/slider03.jpg);">
						<div class="container">
					...
					<div class="item" style="background-image: url(/farmstory/resources/assets/images/art/slider04.jpg);">
						<div class="container">
					...
					<div class="item" style="background-image: url(/farmstory/resources/assets/images/art/slider05.jpg);">
						<div class="container">
			...
			<section id="visit-our-store" class="img-bg img-bg-soft tint-bg" style="background-image: url(/farmstory/resources/assets/images/art/image-background04.jpg);">
				<div class="container inner">
									...
									<div class="tab-content" id="tab-1">
										<div class="row">
											...
											<div class="col-md-5 col-md-push-5 col-md-offset-1 col-sm-6 col-sm-push-6 inner-left-xs">
												<figure><img src="/farmstory/resources/assets/images/art/product04.jpg" alt=""></figure>
											</div><!-- /.col -->
									...
									<div class="tab-content" id="tab-2">
										<div class="row">
											...
											<div class="col-md-5 col-md-offset-1 col-sm-6 inner-right-xs">
												<figure><img src="/farmstory/resources/assets/images/art/product05.jpg" alt=""></figure>
											</div><!-- /.col -->
									...
									<div class="tab-content" id="tab-3">
										<div class="row">
											...
											<div class="col-md-4 col-md-push-3 col-md-offset-1 col-sm-6 inner-left-xs inner-right-xs">
												<figure><img src="/farmstory/resources/assets/images/art/product06.jpg" alt=""></figure>
											</div><!-- /.col -->
