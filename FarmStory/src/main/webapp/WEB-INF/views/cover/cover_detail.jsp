			...
			<div class="row">
				<div class="col-sm-12 portfolio">
					...
					<table class="table listingsTable" style="border-radius: 30px">
						...
						<tr style="background-color: white; height: 30px">
							<td colspan="2"><img
								src="/janditour/resources/upload-image/travelnote-info/${travelNote.trnPic}"
					...
					<a id="update" href="#">글수정</a> <a id="list"
						href="travelnote_list.action">목록보기</a> <a id="delete"
						href="travelnote_delete.action?trnNo=${travelNote.trnNo}">삭제</a> <input
