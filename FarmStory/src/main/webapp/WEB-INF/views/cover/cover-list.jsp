...
<table class="table listingsTable" style="border-radius: 30px">             
              ...
              <tr style="background-color:white;height:30px">
                <td colspan="2"><a href="cover_detail.action?trnNo=${ cover.trnNo }"> ${ cover.trnTitle } </a></td>
              </tr>
              <tr style="background-color:white;height:30px">        
                <td colspan="2"><img src="/janditour/resources/upload-image/cover-info/${cover.trnPic}" style="width:80px;height:50px"></a></td>
              </tr>
              <tr style="background-color:white;height:30px">
			...
			<a id="link_register" href="javascript:">소개 등록</a>
