				...
				<div class="container inner">
					<div class="row">
						<div class="col-md-8">
							...
							</header></div></div></div></section><div class="container inner">
				<div class="row">
					...
					<div class="col-md-15 inner-right-md">
						...
						<section id="cover-form-section">
							...
							<form id="cover-form" action="cover_write.action" method="post" enctype="multipart/form-data">
								
								<div class="row">
									<div class="col-sm-6">
										<input type="text" name="covTitle" class="form-control" value="${ cover.covTitle }" placeholder="제목을 입력해주세요">
									</div><!-- /.col -->
								</div><!-- /.row -->
								...
								<div class="row">
									<div id="addImage">
										<div class="col-sm-6">
										<input type="file" name="covImage1" id="file" class="form-control">
										</div><!-- /.col -->
									</div>
								...
								<div class="row">
									<div class="col-sm-20">
										<textarea name="covContent" id="smarteditor" class="form-control" >${cover.covLcontent}</textarea>
										<textarea name="covContent" id="smarteditor" class="form-control" >${cover.covRocntent}</textarea>
									</div><!-- /.col -->
								</div><!-- /.row -->
						...
						<section id="contacts" class="inner-top-md inner-bottom-sm">
							...
							<h2>Contacts</h2>
							<p>Magnis modipsae voloratati andigen daepeditem quiate re aut labor. <br>Laceaque eictemperum quiae sitiorem rest non restibusaes.</p>
